...
extern "C"
{
	...
	/// <param name="sampledScales">An optional argument specifying presampled compressed (lossy) uniform scales. These participate in error analysis.
	/// See the detailed documentation for the layout. Pass in nullptr if there are no scales. </param>
	...
	/// 
	/// The expected layout in sampledScales is transposed relative to aosClipData. That is all values for all transforms for sample 0 come first, then all
	/// values for all transforms for sample 1, and so on.
	/// 
